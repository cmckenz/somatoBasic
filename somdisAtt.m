...
task{1}.seglen = [1 1.25 1 1];
task{1}.synchToVol = [1 0 0 1];
task{1}.getResponse = [0 1 1 0];
task{1}.parameter.pedestal = [0.0625 0.125 0.25 0.375 0.5];
task{1}.randVars.uniform.side = [-1 1];
task{1}.randVars.uniform.interval = [0 1];
task{1}.randVars.uniform.attention = [0 1];
